...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(10), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _l10n, _pubsubhub) {
  ...
  function showInlineError(elems, msg, title) {
    ...
    (0, _pubsubhub.pub)("error", "".concat(msg, " at: ").concat(links, "."));
  ...
  function getDfnTitles(elem, {
    ...
    if (elem.dataset.lt) {
      ...
      if (normText !== "" && !titleString.startsWith("".concat(normText, "|"))) {
        // Use the definition itself, so to avoid having to declare the definition twice.
        titleString += "|".concat(normText);
      }
...
/* harmony import */ var _sanitizer_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(29);
...
function createInfo(options, template) {
  var markup = Object(_sanitizer_js__WEBPACK_IMPORTED_MODULE_4__["default"])(template);
...
/* harmony default export */ __webpack_exports__["default"] = (function (template) {
  return template.join(_constants_js__WEBPACK_IMPORTED_MODULE_0__["UIDC"])
...
var findAttributes = new RegExp('(' + attrName + '\\s*=\\s*)([\'"]?)' + _constants_js__WEBPACK_IMPORTED_MODULE_0__["UIDC"] + '\\2', 'gi');
...
function replaceAttributes($0, $1, $2) {
  return $1 + ($2 || '"') + _constants_js__WEBPACK_IMPORTED_MODULE_0__["UID"] + ($2 || '"');
}

function fullClosing($0, $1, $2) {
  return _constants_js__WEBPACK_IMPORTED_MODULE_0__["VOID_ELEMENTS"].test($1) ? $0 : ('<' + $1 + $2 + '></' + $1 + '>');
}
...
/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30);
...
function parse(node, holes, parts, path) {
  ...
  while (i < length) {
    ...
    switch (child.nodeType) {
      case _constants_js__WEBPACK_IMPORTED_MODULE_2__["ELEMENT_NODE"]:
        var childPath = path.concat(i);
        parseAttributes(child, holes, parts, childPath);
        parse(child, holes, parts, childPath);
        break;
      case _constants_js__WEBPACK_IMPORTED_MODULE_2__["COMMENT_NODE"]:
        if (child.textContent === _constants_js__WEBPACK_IMPORTED_MODULE_2__["UID"]) {
          parts.shift();
          holes.push(
            // basicHTML or other non standard engines
            // might end up having comments in nodes
            // where they shouldn't, hence this check.
            _constants_js__WEBPACK_IMPORTED_MODULE_2__["SHOULD_USE_TEXT_CONTENT"].test(node.nodeName) ?
              create('text', node, path) :
              create('any', child, path.concat(i))
          );
        }
        break;
      case _constants_js__WEBPACK_IMPORTED_MODULE_2__["TEXT_NODE"]:
        ...
        if (
          _constants_js__WEBPACK_IMPORTED_MODULE_2__["SHOULD_USE_TEXT_CONTENT"].test(node.nodeName) &&
          _ungap_trim__WEBPACK_IMPORTED_MODULE_1__["default"].call(child.textContent) === _constants_js__WEBPACK_IMPORTED_MODULE_2__["UIDC"]
        ) {
          parts.shift();
...
function parseAttributes(node, holes, parts, path) {
  ...
  while (i < length) {
    ...
    if (attribute.value === _constants_js__WEBPACK_IMPORTED_MODULE_2__["UID"]) {
...
/* harmony default export */ __webpack_exports__["default"] = (templateLiteral);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _hyperhtml) {
  ...
  function linkToCommunity(conf, opts) {
    ...
    return (0, _hyperhtml.default)(_templateObject27(), conf.github ? (0, _hyperhtml.default)(_templateObject28(), conf.issueBase) : "", conf.wgPublicList ? (0, _hyperhtml.default)(_templateObject29(), conf.github && conf.wgPublicList ? "Alternatively, you can send comments to our mailing list." : "Comments regarding this document are welcome.", opts.mailToWGPublicListWithSubject, conf.wgPublicList, "https://lists.w3.org/Archives/Public/".concat(conf.wgPublicList, "/"), conf.subjectPrefix ? (0, _hyperhtml.default)(_templateObject30(), conf.subjectPrefix) : "") : "");
  }
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(13), __webpack_require__(75), __webpack_require__(76)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _hyperhtml, _inlineIdlParser, _renderBiblio) {
  ...
  function _templateObject3() {
    const data = _taggedTemplateLiteral(["<a class=\"respec-inline-expansion\" href=\"", "\"></a>"]);
  ...
  function _templateObject2() {
    const data = _taggedTemplateLiteral(["<a class=\"respec-inline-expansion\" data-cite=\"", "\"></a>"]);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(13), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _hyperhtml, _utils) {
  ...
  const enumRegex = /^(\w+)\["([\w ]+)"\]$/;
  const enumValueRegex = /\B"([^"]*)"\B/; // TODO: const splitRegex = /(?<=\]\]|\b)\./
  ...
  function parseInlineIDL(str) {
    ...
    const tokens = nonMethodPart.split(".").concat(methodPart).filter(s => s && s.trim());
    const results = [];
  ...
  function renderInternalSlot(details) {
    ...
    const html = (0, _hyperhtml.default)(_templateObject2(), parent ? "." : "", linkFor, linkFor, lt, identifier);
    return html;
  ...
  function renderAttribute(details) {
    ...
    const html = (0, _hyperhtml.default)(_templateObject3(), linkFor, linkFor, identifier);
    return html;
  ...
  function renderMethod(details) {
    ...
    const html = (0, _hyperhtml.default)(_templateObject4(), parent ? "." : "", type, linkFor, linkFor, searchText, identifier, [argsText]);
    return html;
  ...
  function renderEnum(details) {
    ...
    const html = (0, _hyperhtml.default)(_templateObject5(), identifier, identifier, enumValue);
    return html;
  ...
  function renderEnumValue(details) {
    ...
    const html = (0, _hyperhtml.default)(_templateObject6(), lt, identifier);
    return html;
  }
  /**
  ...
  function idlStringToHtml(str) {
    ...
    try {
      ...
      const el = (0, _hyperhtml.default)(_templateObject7(), str);
    ...
    const result = render(_templateObject8(), output);
    return result;
  }
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(13), __webpack_require__(9), __webpack_require__(3), __webpack_require__(76), __webpack_require__(74)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _hyperhtml, _utils, _pubsubhub, _renderBiblio, _inlines) {
  ...
  function processConformance(conformance, conf) {
    ...
    if (terms.length) conf.normativeReferences.add("RFC2119"); // Put in the 2119 clause and reference

    const keywords = (0, _utils.joinAnd)(terms.sort(), item => "<em class=\"rfc2119\">".concat(item, "</em>"));
    const plural = terms.length > 1;
    const content = (0, _hyperhtml.default)(_templateObject(), terms.length ? (0, _hyperhtml.default)(_templateObject2(), plural ? "s" : "", [keywords], plural ? "are" : "is", (0, _renderBiblio.renderInlineCitation)("RFC2119")) : null);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(82), __webpack_require__(9), __webpack_require__(56)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _pluralize, _utils, _dfnMap) {
  "use strict";
  ...
  function getPluralizer() {
    ...
    /** @type {string} */
    text) {
      const normText = (0, _utils.norm)(text.toLowerCase());
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(84), __webpack_require__(10), __webpack_require__(13), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _examples, _l10n, _hyperhtml, _pubsubhub) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(86), __webpack_require__(10), __webpack_require__(87), __webpack_require__(13), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _issuesNotes, _l10n, _githubApi, _hyperhtml, _pubsubhub) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(90), __webpack_require__(13), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _bp, _hyperhtml, _pubsubhub) {
  "use strict";
  ...
  _exports.run = run;
  _exports.name = void 0;
  _bp = _interopRequireDefault(_bp);
  _hyperhtml = _interopRequireDefault(_hyperhtml);
  ...
  function _templateObject2() {
    const data = _taggedTemplateLiteral(["<span class=\"practicetitle\">Best Practice ", "</span>: "]);
  ...
  function _templateObject() {
    const data = _taggedTemplateLiteral(["<li><a href=\"", "\">Best Practice ", "</a>: ", "</li>"]);
  ...
  function run() {
    ...
    for (const bp of bps) {
      ...
      const li = (0, _hyperhtml.default)(_templateObject(), "#".concat(id), num, bp.textContent);
      ul.appendChild(li);
      ul.classList.add("practicebox");
      const title = (0, _hyperhtml.default)(_templateObject2(), num);
    ...
    if (bps.length) {
      document.head.insertBefore((0, _hyperhtml.default)(_templateObject3(), [_bp.default]), document.head.querySelector("link"));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/* --- Best Practices ---  */\n\nspan.practicelab {\n  display: block;\n  color: #005A9C;\n  margin-bottom: 1em;\n}\n\nspan.practicetitle {\n  color: #005A9C;\n  text-decoration: underline;\n  margin-bottom: 1em;\n}\n\np.practicedesc {\n  padding: 2em;\n  border-left-width: 0.5em;\n  border-left-style: solid;\n  border-color: #8CCBF2;\n  background: \n  rgb(241, 246, 253);\n}\n\n.practicebox {\n    background: black;\n}\n\n@media (max-width: 767px) {\n  span.practicetitle {\n    display: block;\n  }\n}\n");
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(10), __webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _l10n, _hyperhtml) {
  ...
  function _templateObject4() {
    const data = _taggedTemplateLiteral(["<span class='figno'>", "</span>"]);
  ...
  function run(conf) {
    ...
    const {
      tof
    } = collectFigures(conf); // Create a Table of Figures if a section with id 'tof' exists.

    const tofElement = document.getElementById("tof");

    if (tof.length && tofElement) {
      decorateTableOfFigures(tofElement);
      tofElement.append((0, _hyperhtml.default)(_templateObject(), l10n.table_of_fig), (0, _hyperhtml.default)(_templateObject2(), tof));
    }
  }
  /**
   * process all figures
  ...
  function decorateFigure(figure, caption, i, conf) {
    ...
    caption.prepend(conf.l10n.fig, (0, _hyperhtml.default)(_templateObject4(), i + 1), " ");
  }
  /**
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(93), __webpack_require__(94), __webpack_require__(95), __webpack_require__(9), __webpack_require__(13), __webpack_require__(3), __webpack_require__(56)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, webidl2, _webidl2, _dfnFinder, _utils, _hyperhtml, _pubsubhub, _dfnMap) {
  "use strict";
  ...
  function _templateObject15() {
    const data = _taggedTemplateLiteral(["<a data-cite=\"WEBIDL#default-tojson-operation\">", "</a>"]);
  ...
  function _templateObject14() {
    const data = _taggedTemplateLiteral(["<a data-link-for=\"", "\" data-lt=\"", "\">", "</a>"]);
  ...
  function _templateObject13() {
    const data = _taggedTemplateLiteral(["<pre class=\"def idl\">", "</pre>"]);
  ...
  function _templateObject11() {
    const data = _taggedTemplateLiteral(["<a>", "</a>"]);
  ...
  function _templateObject5() {
    const data = _taggedTemplateLiteral(["<a data-link-for=\"\">", "</a>"]);
  ...
  function makeMarkup(parse, {
    ...
    const templates = {
      wrap(items) {
        return items.reduce(_utils.flatten, []).map(x => typeof x === "string" ? new Text(x) : x);
      },
      ...
      generic(wrapped) {
        if (standardTypes.has(wrapped)) {
          return (0, _hyperhtml.default)(_templateObject2(), standardTypes.get(wrapped), wrapped);
        }

        return (0, _hyperhtml.default)(_templateObject3(), wrapped);
      },

      reference(wrapped, name) {
        if (standardTypes.has(name)) {
          return (0, _hyperhtml.default)(_templateObject4(), standardTypes.get(name), wrapped);
        }

        return (0, _hyperhtml.default)(_templateObject5(), wrapped);
      },
      ...
      name(escaped, {
        ...
        if (data.idlType && data.idlType.type === "argument-type") {
          return (0, _hyperhtml.default)(_templateObject6(), escaped);
        }
        ...
        return (0, _hyperhtml.default)(_templateObject7(), className, idlAnchor);
      },

      type: contents => (0, _hyperhtml.default)(_templateObject8(), contents),
      inheritance: contents => (0, _hyperhtml.default)(_templateObject9(), contents),
      definition: createIdlElement,
      extendedAttribute: contents => (0, _hyperhtml.default)(_templateObject10(), contents),
      ...
      extendedAttributeReference(name) {
        ...
        return (0, _hyperhtml.default)(_templateObject12(), extendedAttributesLinks.get(name), name);
      }

    };
    const result = webidl2.write(parse, {
      templates
    });
    return (0, _hyperhtml.default)(_templateObject13(), result);
  }

  function createIdlAnchor(escaped, data, parentName, dfn) {
    if (dfn) {
      return (0, _hyperhtml.default)(_templateObject14(), parentName.toLowerCase(), dfn.dataset.lt || "", escaped);
    }

    const isDefaultJSON = data.type === "operation" && data.name === "toJSON" && data.extAttrs && data.extAttrs.items.some(({
      name
    }) => name === "Default");

    if (isDefaultJSON) {
      return (0, _hyperhtml.default)(_templateObject15(), escaped);
    }

    return escaped;
  }

  function createIdlElement(contents, {
    data,
    parent
  }) {
    ...
    switch (data.type) {
      case "includes":
      case "enum-value":
        return (0, _hyperhtml.default)(_templateObject16(), className, contents);
    }
    ...
    return (0, _hyperhtml.default)(_templateObject17(), className, idlId, name, contents);
  }
      ...
      case "operation":
        {
          ...
          if (overload) {
            ...
            idlId += defn.body.arguments.map(arg => "-".concat(arg.name.toLowerCase())).join("");
          }
  ...
  function run() {
    ...
    idls.forEach(idlElement => {
      ...
      try {
        ...
        (0, _pubsubhub.pub)("error", "Failed to parse WebIDL: ".concat(e.message, ".\n        <details>\n        <pre>").concat(idlElement.textContent, "\n ").concat(e, "</pre>\n        </details>")); // Skip this <pre> and move on to the next one.
      ...
      newElement.querySelectorAll("[data-idl]").forEach(elem => {
        const title = elem.dataset.title.toLowerCase(); // Select the nearest ancestor element that can contain members.
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(56), __webpack_require__(3), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _dfnMap, _pubsubhub, _utils) {
  ...
  // @ts-check
  const topLevelEntities = new Set(["callback interface", "callback", "dictionary", "enum", "interface mixin", "interface", "typedef"]); // TODO: make these linkable somehow.
  ...
  function findDfn(defn, name, {
    ...
    if (showWarnings) {
      const styledName = defn.type === "operation" ? "".concat(name, "()") : name;
      const ofParent = parent ? " `".concat(parent, "`'s") : "";
      (0, _pubsubhub.pub)("warn", "Missing `<dfn>` for".concat(ofParent, " `").concat(styledName, "` ").concat(defn.type, ". [More info](https://github.com/w3c/respec/wiki/WebIDL-thing-is-not-defined)."));
    }
  }
  /**
   * @param {*} defn
  ...
  function findAttributeDfn(defn, parent, name) {
    ...
    const asQualifiedName = "".concat(parentLow, ".").concat(asLocalName);
  ...
  function findOperationDfn(defn, parent, name) {
    ...
    const parentLow = parent.toLowerCase(); // Allow linking to both "method()" and "method" name.

    const asLocalName = name.toLowerCase();
    const asMethodName = "".concat(asLocalName, "()");
    const asQualifiedName = "".concat(parentLow, ".").concat(asLocalName);
    ...
    addAlternativeNames(dfn, [asFullyQualifiedName, asQualifiedName, asMethodName, asLocalName]);
    return dfn;
  }
  /**
   * @param {HTMLElement} dfn
  ...
  function findNormalDfn(defn, parent, name) {
    const parentLow = parent.toLowerCase();
    let resolvedName = defn.type === "enum-value" && name === "" ? "the-empty-string" : name;
    const nameLow = resolvedName.toLowerCase();
    let dfnForArray = _dfnMap.definitionMap[nameLow];
    let dfns = getDfns(dfnForArray, parentLow, name, defn.type); // If we haven't found any definitions with explicit [for]
    // and [title], look for a dotted definition, "parent.name".

    if (dfns.length === 0 && parentLow !== "") {
      resolvedName = "".concat(parentLow, ".").concat(nameLow);
      dfnForArray = _dfnMap.definitionMap[resolvedName];
      ...
      if (dfnForArray !== undefined && dfnForArray.length === 1) {
        ...
        (0, _dfnMap.registerDefinition)(dfns[0], [nameLow]);
      }
    }
  ...
  function decorateDfn(dfn, defn, parent, name) {
    if (!dfn.id) {
      const middle = parent ? "".concat(parent, "-") : "";
  ...
  function getDataType(idlStruct) {
    ...
    if (type === "operation") return getDataType(body.idlType); // join on "|" handles for "unsigned short" etc.
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(77), __webpack_require__(9), __webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _biblio, _utils, _hyperhtml) {
  "use strict";
  ...
  function requestLookup(conf) {
    ...
    return async elem => {
      ...
      switch (elem.localName) {
        ...
        case "dfn":
          {
            const anchor = (0, _hyperhtml.default)(_templateObject(), href);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(99), __webpack_require__(10), __webpack_require__(56), __webpack_require__(96), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _xref, _l10n, _dfnMap, _dataCite, _pubsubhub) {
  "use strict";
  ...
  async function run(conf) {
    ...
    const badLinks = [];
    const localLinkSelector = "a[data-cite=''], a:not([href]):not([data-cite]):not(.logo)";
    document.querySelectorAll(localLinkSelector).forEach(
    /** @type {HTMLAnchorElement} */
    ant => {
      if (ant.classList.contains("externalDFN")) return;
      const linkTargets = (0, _utils.getLinkTargets)(ant);
  ...
  function assignDfnId(dfn, title) {
    if (!dfn.id) {
      ...
      if (dfn.dataset.idl) {
        (0, _utils.addId)(dfn, "dom", (dfnFor ? "".concat(dfnFor, "-") : "") + title);
      } else {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(100), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _idb, _pubsubhub) {
  "use strict";
  ...
  async function getData(queryKeys, apiUrl) {
    ...
    try {
      const idb = await (0, _idb.openDB)("xref", 1, {
        upgrade(db) {
          db.createObjectStore("xrefs");
        }

      });
      cache = new _utils.IDBKeyVal(idb, "xrefs");
  ...
  function addDataCiteToTerms(elems, queryKeys, data, conf) {
    ...
    for (let i = 0, l = elems.length; i < l; i++) {
      ...
      switch (results.length) {
        ...
        case 0:
          {
            const collector = errorsTermNotFound.get(term) || errorsTermNotFound.set(term, []).get(term);
            collector.push(elem);
            break;
          }
        ...
        default:
          {
            const collector = errorsAmbiguous.get(id) || errorsAmbiguous.set(id, {
              term,
              results,
              elems: []
            }).get(id);
  ...
  function showErrors({
    ...
    const dataCiteLink = "[`data-cite`](https://github.com/w3c/respec/wiki/data--cite)";
    const titleForNotFound = "Error: No matching dfn found.";
    const hintForNotFound = "Please provide a ".concat(dataCiteLink, " attribute for it.");

    for (const [term, elems] of errorsTermNotFound) {
      const msg = "Couldn't match \"**".concat(term, "**\" to anything in the document ") + "or to any other spec. ".concat(hintForNotFound);
      (0, _utils.showInlineError)(elems, msg, titleForNotFound);
    }

    const titleForAmbiguous = "Error: Linking an ambiguous dfn.";

    for (const _ref of errorsAmbiguous.values()) {
      const {
        term,
        elems,
        results
      ...
      const specs = [...definedInSpecs].map(s => "**".concat(s, "**")).join(", ");
      const msg = "The term \"**".concat(term, "**\" is defined in ").concat(specs, " in multiple ways, so it's ambiguous.");
      let hint = "";
      ...
      if (definedInSpecs.size === 1) {
        ...
        const forContext = [...xrefFor].map(s => "**".concat(s, "**")).join(", ");
        hint = "add `data-xref-for` attribute with value equal to one of the following: ".concat(forContext, ".");
      } else {
        // defined in multiple specs
        hint = "add ".concat(dataCiteLink, " attribute with value equal to one of the following: ").concat(specs, ".");
      }

      const message = "".concat(msg, " To disambiguate, you need to ").concat(hint);
      (0, _utils.showInlineError)(elems, message, titleForAmbiguous);
    }
  }
...
/* harmony import */ var _chunk_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(101);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(87), __webpack_require__(9), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _githubApi, _utils, _pubsubhub) {
  "use strict";
  ...
  async function toHTML(urls, editors, element, headers) {
    const args = await Promise.all(urls.map(url => fetch(new Request(url, {
      headers
    })).then(r => {
  ...
  async function run(conf) {
    ...
    const response = await fetch(new Request(githubAPI, {
      headers
    }));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(3), __webpack_require__(108), __webpack_require__(9), __webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _pubsubhub, _caniuse, _utils, _hyperhtml) {
  "use strict";
  ...
  async function run(conf) {
    ...
    const featureURL = "https://caniuse.com/#feat=".concat(options.feature);
    ...
    const contentPromise = new Promise(async resolve => {
      ...
      try {
        ...
        (0, _pubsubhub.pub)("error", msg);
        content = (0, _hyperhtml.default)(_templateObject2(), featureURL);
      }
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(13), __webpack_require__(110)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _hyperhtml, _mdnAnnotation) {
  "use strict";
  ...
  function fetchAndCacheJson(url, maxAge) {
    ...
    return (0, _utils.fetchAndCache)(request, maxAge).then(r => r.json());
  }
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(10), __webpack_require__(13), __webpack_require__(3), __webpack_require__(112), __webpack_require__(11)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _l10n, _hyperhtml, _pubsubhub, _exporter, _ui) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(4), __webpack_require__(13), __webpack_require__(3), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _exposeModules, _hyperhtml, _pubsubhub, _utils) {
  "use strict";
  ...
  function cleanupHyper({
    ...
    const filter = comment => comment.textContent.startsWith("-") && comment.textContent.endsWith("%");
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(10), __webpack_require__(13), __webpack_require__(11), __webpack_require__(77)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_l10n, _hyperhtml, _ui, _biblio) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(119), __webpack_require__(13), __webpack_require__(9), __webpack_require__(120)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _github, _hyperhtml, _utils, _worker) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(4), __webpack_require__(121)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _exposeModules, _respecWorker) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(123)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _clipboard) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(127), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _var, _pubsubhub) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(129)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _datatype) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(131)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _algorithms) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils) {
  ...
  function processFigure(matchingElement, id, a) {
    ...
    const children = [...makeSafeCopy(figcaption)].filter(node => !node.classList || !node.classList.contains("fig-title")); // drop an empty space at the end.
  ...
  function processHeading(heading, a) {
    ...
    const children = [...makeSafeCopy(heading)].filter(node => !node.classList || !node.classList.contains("self-link"));
    a.append(...children);
  ...
  function makeSafeCopy(node) {
    ...
    return [...clone.childNodes].filter(node => node.nodeType !== Node.COMMENT_NODE);
  }
  ...
  function localize(matchingElement, newElement) {
    for (const attrName of ["dir", "lang"]) {
      ...
      const newClosest = newElement.closest("[".concat(attrName, "]")); // It's the same, so already inherited from closet (probably HTML element or body).

      if (matchingClosest === newClosest) continue; // Otherwise, apply it.
